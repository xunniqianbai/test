...
class UNet3D_ViT_GCN(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, patch_size=16, dim=128, depth=6, heads=8, mlp_ratio=4., qkv_bias=True, gcn_channels=32, gcn_layers=2):
        super().__init__()
        self.patch_size = patch_size
        # UNet3D Encoder
        ...
        # ViT
        self.vit = ViT(image_size=patch_size, in_channels=dim, num_classes=gcn_channels, dim=gcn_channels, depth=gcn_layers, heads=heads, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias)
        # GCN
